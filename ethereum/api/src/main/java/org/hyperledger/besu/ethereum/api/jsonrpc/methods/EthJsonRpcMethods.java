  ...
  protected Map<String, JsonRpcMethod> create() {
    final Map<String, JsonRpcMethod> map =
        mapOf(
            ...
            new EthCall(blockchainQueries, transactionSimulator, metricsSystem, protocolSchedule),
            new EthFeeHistory(
            ...
            new EthEstimateGas(blockchainQueries, transactionSimulator, apiConfiguration, protocolSchedule),
