...
class AbstractBlockProcessorIntegrationTest {
  ...
  void blockAccessListStateRootMatchesAccumulatorForStorageAndReads(
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x16d967e9fa30223dfb8495fa9196d6361584a21ed293038f31b145793fb526fd",
            Wei.of(5),
            setSlot1Transaction,
            getSlot1Transaction,
            setSlot3Transaction,
  ...
  void processContractSlotUpdateThenReadTx(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0xb2c193695106fa9c41b001ae6b4fa72903f1f728d93c45a4ffdf296be456bfb6",
            Wei.of(5),
            setSlot1Transaction,
            getSlot1Transaction,
            setSlot3Transaction,
  ...
  void processSlotReadThenUpdateTx(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x13a1d812227e24e1e39270cf2007780b43a960eb20fdf3ddf742f5f40c36f520",
            Wei.of(5),
            getSlot1Transaction,
            setSlot1Transaction,
            setSlo2Transaction,
  ...
  void processAccountReadThenUpdateTx(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x0afdce26b1b70cd28d15ea6b205526b9020c85a6bc7837b5f46c863d17ce6dc9",
            Wei.of(5),
            transactionTransfer,
  ...
  void processAccountUpdateThenReadTx(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x44baae0ae5c086d615fa0709b314da5243381563fc060b2b1fd5b29a6a28b5ba",
            Wei.of(5),
            transactionTransfer,
            sendEthFromContractTransaction,
            getcontractBalanceTransaction);
  ...
  void processAccountReadThenUpdateTxWithTwoAccounts(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x7399edd09c1932034c14e472d13c84f0b63ddd636f18610b09a2e5894e792562",
            Wei.of(5),
            transactionTransfer,
            getcontractBalanceTransaction,
            sendEthFromContractTransaction);
