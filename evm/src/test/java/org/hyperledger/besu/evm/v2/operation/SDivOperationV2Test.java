...
class SDivOperationV2Test {
  ...
  static Iterable<Arguments> data() {
    return List.of(
      ...
      Arguments.of("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff6", "0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe", "0x05"));
  }
