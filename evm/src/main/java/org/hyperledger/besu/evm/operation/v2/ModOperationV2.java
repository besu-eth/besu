...
/**
 * EVM v2 MOD operation using long[] stack representation.
 *
 * <p>Performs unsigned 256-bit modulo reduction. If the modulus is zero, the result is zero per EVM
 * specification.
 */
public class ModOperationV2 extends AbstractFixedCostOperationV2 {

  private static final Operation.OperationResult MOD_SUCCESS =
   ...
   */
  public ModOperationV2(final GasCalculator gasCalculator) {
  ...
  /**
   * Performs MOD on the v2 long[] stack.
   *
  ...
  public static Operation.OperationResult staticOperation(
    ...
    if (s[b] == 0L && s[b + 1] == 0L && s[b + 2] == 0L && s[b + 3] == 0L) {
      ...
      final UInt256 result = val0.mod(val1);
