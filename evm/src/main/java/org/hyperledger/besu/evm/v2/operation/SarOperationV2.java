...
public class SarOperationV2 extends AbstractFixedCostOperationV2 {
  ...
  public static OperationResult staticOperation(final MessageFrame frame) {
    ...
    final UInt256 shift = new UInt256(_stack[shiftOffset], _stack[shiftOffset + 1], _stack[shiftOffset + 2], _stack[shiftOffset + 3]);
    ...
    _stack[resultOffset + 1] = result.u2();
    _stack[resultOffset + 2] = result.u1();
    _stack[resultOffset + 3] = result.u0();
    frame.setTopV2(++top);
    return sarSuccess;
  }
}
