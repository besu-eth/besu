...
public class IsZeroOperationV2 extends AbstractFixedCostOperationV2 {
  ...
  private static final Operation.OperationResult ISZERO_SUCCESS =
  ...
  /**
   * Performs ISZERO on the v2 long[] stack.
   *
  ...
  public static Operation.OperationResult staticOperation(
    ...
    final boolean isZero = s[a] == 0L && s[a + 1] == 0L && s[a + 2] == 0L && s[a + 3] == 0L;
