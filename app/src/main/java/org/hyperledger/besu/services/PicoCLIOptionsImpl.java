...
public class PicoCLIOptionsImpl implements PicoCLIOptions {
  ...
  /**
   * Closes the option registry: later calls to {@link #addPicoCLIOptions} throw {@link
   * OptionsAlreadyParsedException}.
   */
  ...
  static class OptionsAlreadyParsedException extends IllegalStateException {
     ...
     */
    OptionsAlreadyParsedException(final String namespace) {
      super(
