...
### Bug fixes
- `debug_getRawReceipts` rejected block-hash parameters with `Invalid block param (block not found)`; it now accepts a block hash, number, or tag, per the execution-apis spec. [#XXXX](https://github.com/besu-eth/besu/pull/XXXX)
