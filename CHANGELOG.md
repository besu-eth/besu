...
### Bug fixes
- Keep Parity trace errors local to the failed call instead of marking successful siblings or callers of failed precompiles as reverted. [#11345](https://github.com/besu-eth/besu/pull/11345)
