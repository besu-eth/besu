...
- Fix flaky `shouldConnectNodesViaV5EnrBootnodesInGenesis`, which reserved p2p ports via a `ServerSocket` and closed it before Besu bound them, letting another process claim the port in between. [#10913](https://github.com/besu-eth/besu/issues/10913)
