...
### Bug fixes
- Preserve a live status-exchanged connection for ETH and Snap responses when duplicate peer connections close, avoiding stalled requests. [#10841](https://github.com/besu-eth/besu/pull/10841)
