...
### Bug fixes
- Keep `vmTrace` parent instructions, child bytecode and CALL resumption gas correct after omitted halted opcodes. [#11352](https://github.com/besu-eth/besu/pull/11352)
