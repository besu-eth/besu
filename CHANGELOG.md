...
- DiscV5 discovery now throttles to a slow cadence (`--Xv5-slow-discovery-interval-seconds`, default 30s) once connected peers reach `--Xv5-minimum-peer-ratio` of `--max-peers`, instead of stopping peer search entirely. [#11344](https://github.com/besu-eth/besu/pull/11344)
