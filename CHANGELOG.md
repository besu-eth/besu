...
### Bug fixes
- `debug_getRawReceipts` rejected block-hash parameters with `Invalid block param (block not found)`; it now accepts a block hash, number, or tag, per the execution-apis spec. [#11156](https://github.com/besu-eth/besu/pull/11156)
