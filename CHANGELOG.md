...
### Bug fixes
- Port clash detection now treats TCP and UDP separately, so `--p2p-discovery-port` and `--metrics-port` may share a number. [#10904](https://github.com/besu-eth/besu/issues/10904)
