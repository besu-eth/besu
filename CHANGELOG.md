...
### Bug fixes
- Omit `vmTrace` execution effects for root out-of-gas steps, avoiding fabricated stack results and negative remaining gas. [#11353](https://github.com/besu-eth/besu/pull/11353)
