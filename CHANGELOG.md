...
### Bug fixes
- Fix node stalling under high load on busy blocks with many unique addresses: thread starvation in the address hash cache no longer occurs when transaction pool validation and block processing run concurrently. [#10235](https://github.com/besu-eth/besu/pull/10235)
...
- Fix node running out of memory or getting stuck in a backward sync loop after the consensus client was paused and resumed. ([#10509](https://github.com/besu-eth/besu/issues/10509))
