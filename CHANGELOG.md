...
### Bug fixes
- Parity traces retain nested precompile calls with nonzero transferred or inherited value, with child-local errors and trace paths numbered over retained frames.
