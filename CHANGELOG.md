...
- Fix full `newPendingTransactions` subscription responses to include the shared transaction fields for modern transaction types. [#10516](https://github.com/besu-eth/besu/pull/10516)
